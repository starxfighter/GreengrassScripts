...
wget https://s3.amazonaws.com/ggtestfiles/ggconfig.json -O ggconfig.json
wget https://s3.amazonaws.com/ggtestfiles/IoTAconfig.json -O IoTAconfig.json
wget https://s3.amazonaws.com/ggtestfiles/FullGGandIOTA.py -O createFullGG.py
wget https://s3.amazonaws.com/ggtestfiles/uConfig.json -O uConfig.json
wget https://s3.amazonaws.com/ggtestfiles/UpdateLambda.py -O UpdateLambda.py
sudo cd /
sudo mkdir /Tmp
cd /greengrass/certs/ 
